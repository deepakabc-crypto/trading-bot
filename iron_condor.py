...
class IronCondorStrategy:
    ...
    def enter_position(self):
        try:
            ...
            return {
                'success': all_ok, 'positions': positions, 'trades': trades,
                'spot_price': spot, 'ce_sell_strike': ce_sell, 'ce_buy_strike': ce_buy,
                'pe_sell_strike': pe_sell, 'pe_buy_strike': pe_buy,
