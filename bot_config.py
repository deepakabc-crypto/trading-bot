...
IMPORTANT: Named bot_config.py (NOT config.py)
...
class Config:
    def __init__(self):
        ...
        # NIFTY: 65 per lot, 50-pt strikes, NFO
        nifty_defaults = {
        ...
        self.indices['NIFTY'] = IndexConfig(
            name='NIFTY', stock_code='NIFTY', exchange='NFO',
            lot_qty=65, strike_step=50, cash_code='NIFTY',
            defaults=nifty_defaults,
        )
        self.indices['NIFTY'].enabled = os.environ.get(
            'NIFTY_ENABLED', 'true').lower() == 'true'

        # SENSEX: 20 per lot, 100-pt strikes, BFO
        sensex_defaults = {
        ...
        self.indices['SENSEX'] = IndexConfig(
            name='SENSEX', stock_code='SENSEX', exchange='BFO',
            lot_qty=20, strike_step=100, cash_code='SENSEX',
