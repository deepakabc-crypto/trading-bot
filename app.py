        ...
        async function refreshData() {
            try {
                ...
                if (data.current_position) {
                    ...
                    html += `<div><strong>Strategy:</strong> ${pos.strategy}</div>`;
                    html += `<div><strong>Entry Time:</strong> ${pos.entry_time}</div>`;
                    html += `<div><strong>Spot:</strong> ₹${pos.spot}</div>`;
                    html += `<div><strong>Entry Premium:</strong> ₹${pos.entry_premium}</div>`;
